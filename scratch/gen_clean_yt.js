...
const cleanYoutubeCode = `const { cmd, commands } = require('../Utils/command');
...
fs.writeFileSync(path.join(__dirname, 'clean_youtube.js'), cleanYoutubeCode);
console.log('clean_youtube.js updated and generated!');
